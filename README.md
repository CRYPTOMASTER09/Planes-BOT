...
Register Here : [Planes](https://t.me/planesCryptobot/planes?startapp=ref_5GW0H0)

## Fitur

  - Auto Get Account Information
  - Auto Complete New User Tutorial
  - Auto Share Message
  - Auto Complete Tasks
  - Multi Account
...
1. **Kloning repositori:**
   ```bash
   git clone https://github.com/CRYPTOMASTER09/Planes-BOT.git
   ```
   ```bash
   cd Planes-BOT
   ```
